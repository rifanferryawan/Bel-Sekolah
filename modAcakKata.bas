Attribute VB_Name = "modAcakKata"
Public Declare Function sndPlaySound Lib "winmm.dll" Alias "sndPlaySoundA" (ByVal lpszSoundName As String, ByVal uFlags As Long) As Long
Public Declare Sub InitCommonControls Lib "comctl32.dll" ()


Public Function EncryptText(ByVal Plain As String, _
...
itsdone:
    ...
    EncryptText = encrypted2 'Returns the Second Encrypted String
...
Public Function DecryptText(ByVal Encrypted As String, _
    sEncKey As String) As String
